...
![alt text](../assets/message-boxes/display-select-from-list-dialog.png)
![alt text](../assets/message-boxes/display-select-from-list-dialog1.png)
![alt text](../assets/message-boxes/display-select-from-list-dialog2.png)
