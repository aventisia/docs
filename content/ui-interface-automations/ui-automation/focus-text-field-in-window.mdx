...
![Focus Text Field in Window UI](../../assets/ui-automation/focus-text-field-in-window.png)  
![Focus Text Field in Window UI](../../assets/ui-automation/focus-text-field-in-window1.png)
