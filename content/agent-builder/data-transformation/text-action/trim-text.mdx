...
---
 ...
 ![alt text](../../../assets/text-action/trim-text.png)
...
| **Trim Mode** |`Whitespace characters from the beginning and end` |Specifies whether to trim characters from the beginning, end, or both sides of the text.|
| **What to Trim** | `space` | Defines the type of trimming to be applied. |
