...
![alt text](../../../assets/text-action/pad-text.png)
...
|-------------------|----------------|-------------|
| **Original Text**   | `Hello World`   | The original text that needs to be padded. |
| **Padding Direction** | `Right`          | Defines whether to pad on the left, right, or both sides. |
| **Padding Charactor** | `of RPA`      | The text used for padding. |
