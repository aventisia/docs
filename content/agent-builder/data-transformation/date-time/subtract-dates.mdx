...
![alt text](../../../assets/date-time/substract-dates.png)

## Input

- **Start Date Time:** `14-02-2025`
- **End DateTime:** `08-01-2025`
- **Difference Unit:** `Days`

## Output
- **DifferenceValue** is the calculated time difference in the specified unit.
