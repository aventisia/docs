...
### PlainText
- The actual plain text string you want to encrypt.

### Key
- A secret key used to perform the AES encryption. It must be kept safe and secure, as it's required for decryption too.

### EncodingFormat
- Defines how the input text is encoded before encryption. `Unicode` ensures compatibility with a wide range of characters.
---
### Output
