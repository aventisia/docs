...
The **Create Data Table** node allows you to generate a data table from scratch or make a copy (clone) of an existing one. This is useful when you want to build a table for storing, processing, or organizing data as part of your automation flow.
...
![Create Data Table](./create-data-table.png)
