...
![alt text](../../../assets/conditional/conditional-1.png)

![alt text](../../../assets/conditional/conditional2.png)
...
_Use Case:_ Ensure a user's role is "Admin" (`role = "Admin"`).
...
_Use Case:_ Apply a discount if an order exceeds `$100` (`orderTotal > 100`).
...
_Use Case:_ Verify if an email ends with `@gmail.com` (`email ends with "@gmail.com"`).
...
_Use Case:_ Confirm if a user has entered a phone number (`phoneNumber is not empty`).
