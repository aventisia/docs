...
The **Get Details of Web Page** node allows you to retrieve specific information from a web page through a provided web browser instance. This is useful for extracting website metadata, such as titles, descriptions, keywords, visible text, HTML source, or URLs, which can be utilized in tasks like SEO analysis, content extraction, or automated reporting.
