...
![Run JavaScript Function on Web Page](../../../assets/browser-automation/run-javascript-function-on-web-page.png)  
...
- Enter the JavaScript function to execute on the web page.  
- **Example**:  
...
- If true, waits for the script to complete before continuing.

### 5. Timeout Seconds 
- Maximum time in seconds to wait for script completion before failing.

### 6. Output: **Result**
- Retrieves the result of the JavaScript function execution (if the function returns a value).
