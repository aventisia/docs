...
![Copy Folder UI](../../../assets/folder/copy-folder.png)

## Fields and Options

### **1. Folder to Copy** _(Required)_

- Specify the full path of the folder that should be copied.

### **2. Destination Folder** _(Required)_

- Define the full path where the copied folder should be placed.

### **3. If Folder Exists** _(Required)_
