...
![Agent Builder](../assets/create-agent/agent-builder.jpeg)
...
Understanding the components of Agent Builder will give you a clearer picture of how to create, run, and refine your agents:
