...
![alt text](../../../assets/exchange-server/retrieve-exchange-email-messages1.png)

![alt text](../../../assets/exchange-server/retrieve-exchange-email-messages2.png)
...
### Retrieve Email Messages from Custom Folder
