...
![alt text](../../../assets/ftp/rename-ftp-file.png)
...
| **Old File Name** | The full path of the file to be renamed. | `/public/uploads/old_name.txt`  |
| **New file name**  | The new name for the file.               | `new_name.txt`                  |
| **Timeout Seconds**  | Maximum time in seconds to wait before failing due to timeout.              | `30`                  |
| **Outputs**  | Returns true if the file was successfully renamed. | `Success`                  |
---
