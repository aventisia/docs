...
![Find and Replace Words in Word Document](../../../assets/word/find-and-replace-words-in-word-document.png)  

## Fields and Options  

### All Matches
- Choose whether to replace text in all matching occurrences or only the first one  
  - **Enabled** Replace text in all matching occurrences.  
  - **Disabled** Replace text in the first matching occurrence only.  
- This ensures the desired scope of replacement is applied.  

### Text to Find
- Enter the text to find in the document.  
- This ensures the correct text is identified for replacement.  

### Text to Replace With
- Enter the text to replace the found text with.  
- This ensures the correct replacement text is used.  

### Use Wildcards
- Specify whether to use wildcards for the text to find  
...
-This allows for flexible and advanced text searching.  
