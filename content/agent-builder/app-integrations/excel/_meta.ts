...
const meta: MetaRecord = {
  ...
  "auto-fill-range-in-excel-worksheet": {
    title: "Auto-fill Range in Excel Worksheet",
  },
  ...
  "copy-range-from-excel-worksheet-to-datatable": {
    title: "Copy Range from Excel Worksheet to Datatable",
  },
  ...
  "delete-range-from-excel-worksheet": {
    title: "Delete Range from Excel Worksheet",
  },
  ...
  "get-first-free-column-or-row-from-excel-worksheet": {
    title: "Get First Free Column or Row from Excel Worksheet",
  },
